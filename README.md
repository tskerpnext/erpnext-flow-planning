...
├── 0420_銷售訂單結案自動更新客戶物料價格_規劃.md
├── 0420_銷售訂單結案自動更新客戶物料價格_Script.md
├── 待確認事項/
│   └── 0420_銷售訂單自動維護客戶物料價格_待確認.md
└── 遷移及升級/
...
| [0420_銷售訂單結案自動更新客戶物料價格_規劃](0420_銷售訂單結案自動更新客戶物料價格_規劃.md) | 銷售訂單結案後以 Server Script 自動更新 tabItem Price 的流程規劃，含虛擬碼與注意事項 | 2026-04-20 |
| [0420_銷售訂單結案自動更新客戶物料價格_Script](0420_銷售訂單結案自動更新客戶物料價格_Script.md) | 完整 Server Script 程式碼，含防重複觸發、跳過 rate=0、新增/更新 Item Price 邏輯 | 2026-04-20 |

### 待確認事項/

| 文件 | 說明 | 日期 |
|------|------|------|
| [0420_銷售訂單自動維護客戶物料價格_待確認](待確認事項/0420_銷售訂單自動維護客戶物料價格_待確認.md) | 銷售訂單結案後自動更新客戶物料成交價至 Item Price 的需求與待確認項目 | 2026-04-20 |
