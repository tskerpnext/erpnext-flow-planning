...
| [0422_ERPNext單據無法刪除或取消解決方法](0422_ERPNext單據無法刪除或取消解決方法.md) | Stock Entry、Delivery Note、Stock Reconciliation 三種單據被 GL Entry / Serial and Batch Bundle 卡住時的強制取消與刪除步驟，含 Bin 一致性驗證 | 2026-04-22 |
