...
│   └── 0420_銷售訂單建單顯示客戶歷史成交價_ClientScript.md
└── 遷移及升級/
...
| [0420_銷售訂單建單顯示客戶歷史成交價_ClientScript](待確認事項/0420_銷售訂單建單顯示客戶歷史成交價_ClientScript.md) | 建單時填入物料後即時顯示該客戶歷史成交價的 Client Script 規劃，含與 Server Script 版本的升級風險比較 | 2026-04-20 |
