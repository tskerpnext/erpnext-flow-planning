...
| [0430_ERPNext導入規劃時程](待確認事項/0430_ERPNext導入規劃時程.md) | 電纜+加工雙產品線製造業（約188人）的 ERPNext v16 導入時程規劃，含五大模組範圍、核心目標（帳料符合/生產不報工/列印格式）與各階段里程碑；工期壓縮為約6個月（不聘外部顧問，內部自行實施） | 2026-05-12 |
